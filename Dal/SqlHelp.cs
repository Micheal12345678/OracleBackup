...
namespace Dal
{
    public class DBHelp
    {
        ...
        #region 带参数 返回DataReader
        /// <summary>
        /// 查询表,获取多个记录
        /// </summary>
        /// <param name="safeSql"></param>
        /// <returns></returns>
        public static SqlDataReader GetReader(string safeSql, SqlConnection conn)
        {
            try
            {
        ...
        /// <param name="values"></param>
        /// <returns></returns>
        public static DataTable GetDataSet(string sql, SqlConnection conn)
        {
            DataSet ds = new DataSet();
            using (conn)
            {
